        ...
        return (
            <div className="min-h-screen bg-[#eefdf5] flex items-center justify-center">
                <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-800 mb-2">Loading CIDP Data</h3>
                    ...
                    {(selectedSector || selectedPriority) && (
                        <div className="mb-8 flex items-center gap-2 text-sm bg-white/80 backdrop-blur-sm rounded-xl px-4 py-3 shadow-sm border border-emerald-200">
                            ...
                            {selectedSector && (
                                <>
                                    ...
                                    <button
                                        ...
                                        className={`font-semibold px-3 py-1 rounded-lg transition-all ${selectedPriority
                            ...
                            {selectedPriority && (
                                <>
                                    <ChevronRight className="w-4 h-4 text-gray-400" />
                                    <span className="text-gray-700 font-semibold bg-emerald-50 px-3 py-1 rounded-lg">
                            ...
                            <div className={viewMode === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6' : 'space-y-4'}>
                                {selectedSector.prioritySectors.map((priority) => (
                                    <button
                                        ...
                                        className={`bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all p-6 text-left border-2 border-emerald-100 hover:border-emerald-400 group ${viewMode === 'list' ? 'flex items-center gap-6' : ''
                                            }`}
                                    >
                                        {viewMode === 'grid' ? (
                                            <>
                                                ...
                                                <h3 className="text-base font-bold text-gray-900 mb-3 leading-snug">{priority.name}</h3>
                                            ...
                                            <>
                                                ...
                                                <div className="flex-1">
                                                    <h3 className="text-base font-bold text-gray-900 mb-1">{priority.name}</h3>
                        ...
                        <div>
                            <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl p-8 mb-8 border-2 border-emerald-200 relative overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h2 className="text-3xl font-bold text-gray-900 mb-2">{selectedPriority.name}</h2>
                                    <p className="text-base text-gray-600 flex items-center gap-2">
                                        <div className="w-2 h-2 bg-emerald-600 rounded-full"></div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                                {selectedPriority.indicators.map((indicator, index) => (
                                    <div
                                        key={index}
                                        className="bg-white/90 backdrop-blur-sm rounded-xl shadow-md hover:shadow-xl p-5 border-2 border-emerald-100 hover:border-emerald-400 transition-all group"
                                    >
                                        <div className="flex items-start gap-3">
                                            <div className="w-8 h-8 bg-gradient-to-br from-emerald-600 to-teal-700 rounded-lg flex items-center justify-center shadow-md flex-shrink-0 group-hover:scale-110 transition-transform">
                                                <span className="text-white text-xs font-bold">{index + 1}</span>
                                            </div>
                                            <div className="flex-1 min-w-0">
                                                <p className="text-gray-900 font-semibold text-sm leading-relaxed">{indicator.text}</p>
                                                {indicator.source && (
                                ...
                                <div className="flex flex-wrap items-center justify-center gap-6 text-center">
                                    <div className="flex items-center gap-3">
                                        <div className="w-12 h-12 bg-white rounded-xl shadow-md flex items-center justify-center">
                                            <span className="text-2xl font-bold text-emerald-700">{selectedPriority.indicators.length}</span>
                                        </div>
                                        <div className="text-left">
                                            <p className="text-xs text-gray-600 font-medium">Total</p>
                                            <p className="text-sm font-bold text-gray-900">Indicators</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="text-left">
                                            ...
                                            <p className="text-sm font-bold text-gray-900 max-w-[200px] truncate">{selectedPriority.name}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
