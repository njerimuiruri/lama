        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-white">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 text-lg">Loading NAP data...</p>
                </div>
            </div>
        );
    }
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        <button
                            ...
                            className="flex items-center gap-2 px-5 py-3 bg-white text-blue-600 hover:bg-blue-50 rounded-xl transition-colors font-semibold shadow-md"
                        >
                            <ChevronRight className="w-5 h-5 rotate-180" />
                            {selectedSource ? `Back to ${selectedSource}` : 'Back to Sources'}
                        </button>
                        <div className="text-right">
                            <h1 className="text-3xl font-bold text-gray-900">NAP Analytics Dashboard</h1>
                            <p className="text-gray-600">National Adaptation Plans</p>
                        </div>
                    </div>

                    {/* Summary Cards */}
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-blue-500/20">
                            <div className="flex items-center justify-between mb-2">
                                <BarChart3 className="w-10 h-10 text-blue-600" />
                            </div>
                            <h3 className="text-4xl font-bold text-blue-600 mb-1">{statistics.totalIndicators}</h3>
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-purple-200">
                            ...
                            <h3 className="text-4xl font-bold text-purple-600 mb-1">{statistics.totalSources}</h3>
                            <p className="text-sm text-gray-600 font-medium">NAP Sources</p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-amber-200">
                            ...
                            <h3 className="text-4xl font-bold text-amber-600 mb-1">{statistics.totalThematics}</h3>
                            <p className="text-sm text-gray-600 font-medium">Thematic Areas</p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-emerald-200">
                            ...
                            <h3 className="text-4xl font-bold text-emerald-600 mb-1">{Object.keys(statistics.typeCounts).length}</h3>
                            <p className="text-sm text-gray-600 font-medium">Indicator Types</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-gray-900">Indicators by Source</h2>
                                <p className="text-sm text-gray-600">Distribution across NAP documents</p>
                            </div>
                        </div>

                        <div className="mb-6 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-r-lg">
                            <p className="text-sm text-gray-700 leading-relaxed">
                                This chart shows the number of climate adaptation indicators per NAP source, helping identify
                                    ...
                                    return (
                                        <div key={source}>
                                            <div className="flex items-center justify-between mb-2">
                                                ...
                                                <span className="text-sm font-bold text-blue-600">{count} indicators</span>
                                            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                                ...
                                {Object.entries(statistics.thematicCounts)
                                    ...
                                    .map(([thematic, count], index) => {
                                        ...
                                        return (
                                            <div key={thematic}>
                                                <div className="flex items-center justify-between mb-2">
                                                    <span className="text-sm font-medium text-gray-700">{thematic}</span>
                                                ...
                                                <div className="w-full bg-gray-100 rounded-full h-2.5 overflow-hidden">
                                                    <div
                                                        ...
                                                        style={{
                                                            width: `${percentage}%`,
                                                            backgrouNAPolor: thematicColors[index % thematicColors.length]
                                                        }}
                                                    />
                                                </div>
                                            </div>
                                ...
                                <div className="mt-6 text-center">
                                    ...
                                    >
                                        {showAllThematics ? (
                                            ...
                                            <>
                                                <span>View All {Object.entries(statistics.thematicCounts).length} Thematics</span>
                                                <ChevronRight className="w-4 h-4 -rotate-90" />
                                            </>
                                        )}
                                    </button>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <h2 className="text-xl font-bold text-gray-900">Indicator Types</h2>
                                    <p className="text-sm text-gray-600">Classification breakdown</p>
                                </div>
                            </div>
                                            ...
                                            <div key={type}>
                                                ...
                                                <div className="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                                                    <div
                                                        ...
                                                        style={{
                                                            width: `${percentage}%`,
                                                            backgrouNAPolor: typeColors[index % typeColors.length]
                                                        }}
                                                    />
                                                </div>
                                            </div>
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-lg">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Document publication years</p>
                            </div>
                        </div>

                        <div className="mb-6 p-4 bg-purple-50 border-l-4 border-purple-500 rounded-r-lg">
                            <p className="text-sm text-gray-700 leading-relaxed">
                                Timeline showing when NAP documents were published, indicating the evolution of
                                    ...
                                    return (
                                        <div key={year}>
                                            <div className="flex items-center justify-between mb-2">
                                                ...
                                                <span className="text-sm font-bold text-purple-600">{count} indicators</span>
                                            </div>
                                            <div className="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                                                <div
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900">National Adaptation Plans</h1>
                                <p className="text-gray-600 text-sm mt-1">Explore climate adaptation indicators from NAPs</p>
                            </div>
                        </div>
                        ...
                        {!selectedSource && (
                            <button
                                ...
                                className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl hover:shadow-lg transition-all font-medium"
                            >
                ...
                <div className="bg-white border-b border-blue-100">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2">
                        <nav className="flex items-center space-x-2 text-sm">
                            ...
                            <span className="text-gray-700 font-semibold">{selectedSource}</span>
                            {selectedThematic !== 'All' && (
                                <>
                                    <ChevronRight className="w-4 h-4 text-gray-400" />
                                    <span className="text-gray-600">{selectedThematic}</span>
                                </>
                            )}
                        </nav>
                    </div>
                ...
                {!selectedSource ? (
                    <div className="bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
                        <div className="mb-6 text-center">
                            ...
                            <h2 className="text-2xl font-bold text-gray-900 mb-2">Select NAP Source</h2>
                            <p className="text-gray-600">Choose a source to explore indicators</p>
                        </div>
                            ...
                            {sources.map(source => {
                                ...
                                return (
                                    <button
                                        ...
                                        className="group relative bg-gradient-to-br from-blue-50 to-white border-2 border-blue-100 rounded-xl p-5 hover:shadow-lg hover:scale-105 transition-all duration-300 text-left overflow-hidden"
                                    >
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-5 border border-blue-100">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-bold text-gray-900">{selectedSource}</h2>
                                        <p className="text-blue-600 font-semibold text-sm">{filteredData.length} indicators</p>
                                    </div>
                                </div>
                                <div className="flex gap-2">
                                    <button
                                        onClick={() => setShowVisualization(true)}
                                        className="flex items-center gap-2 px-4 py-2 bg-purple-50 hover:bg-purple-100 rounded-lg font-semibold text-purple-700 text-sm transition-all"
                                    >
                            ...
                            <div className="grid sm:grid-cols-3 gap-3">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-3 py-2.5 text-sm bg-blue-50 border-2 border-blue-100 rounded-lg focus:outline-none focus:border-blue-400 focus:bg-white transition-all"
                                    />
                                </div>

                                <div className="relative">
                                    <Filter className="absolute left-3 top-3 w-4 h-4 text-blue-600" />
                                    <select
                                        value={selectedThematic}
                                        onChange={(e) => setSelectedThematic(e.target.value)}
                                        className="w-full pl-10 pr-3 py-2.5 text-sm bg-blue-50 border-2 border-blue-100 rounded-lg focus:outline-none focus:border-blue-400 focus:bg-white cursor-pointer transition-all appearance-none"
                                    >
                                ...
                                <div className="relative">
                                    <Target className="absolute left-3 top-3 w-4 h-4 text-blue-600" />
                                    <select
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 px-1">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <select
                                        ...
                                        className="px-3 py-1.5 text-sm bg-white border-2 border-blue-100 rounded-lg focus:outline-none focus:border-blue-400 cursor-pointer"
                                    >
                        ...
                        {filteredData.length > 0 ? (
                                                    ...
                                                    >
                                                        <td className="px-4 py-3">
                                                            <div className="flex items-start gap-2">
                                                                ...
                                                                <span className="text-gray-900 text-sm leading-snug">
                                                                    {item.Indicator || 'N/A'}
                                                                </span>
                                                            </div>
                                                        </td>
                                                        <td className="px-4 py-3">
                                                            {item['Thematic Target'] ? (
                                                                <span className="inline-flex items-center px-3 py-1 bg-amber-100 text-amber-800 rounded-lg text-xs font-semibold">
                                                                    {item['Thematic Target']}
                                                                </span>
                                                            ) : (
                                                        ...
                                                        <td className="px-4 py-3">
                                                            {item['Indicator Type'] ? (
                                                                <span className="inline-flex items-center px-3 py-1 bg-emerald-100 text-emerald-800 rounded-lg text-xs font-semibold capitalize">
                                                                    {item['Indicator Type']}
                                                                </span>
                                                            ) : (
                                                                <span className="text-gray-400">—</span>
                                                        ...
                                                        <td className="px-4 py-3">
                                                            {item['Document  publication  year'] ? (
                                                                <span className="inline-flex items-center px-3 py-1 bg-purple-100 text-purple-800 rounded-lg text-xs font-semibold">
                                                                    {item['Document  publication  year']}
                                                                </span>
                                                            ) : (
                                                                <span className="text-gray-400">—</span>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-8 text-center border border-blue-100">
                                ...
                                <button
                                    ...
                                    className="px-6 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg font-semibold text-sm hover:shadow-lg hover:scale-105 transition-all"
                                >
                                    Clear All Filters
                                </button>
                            </div>
