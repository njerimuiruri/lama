        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-white">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 text-lg">Loading NDC data...</p>
                </div>
            </div>
        );
    }
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <div className="text-right">
                            <h1 className="text-3xl font-bold text-gray-900">NDC Analytics Dashboard</h1>
                            <p className="text-gray-600">National Determined Contributions</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-purple-200">
                            ...
                            <p className="text-sm text-gray-600 font-medium">NDC Sources</p>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Distribution across NDC documents</p>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900">National Determinant Contributions </h1>
                                <p className="text-gray-600 text-sm mt-1">Explore climate adaptation indicators from NDCs</p>
                            </div>
                        </div>
                ...
                {!selectedSource ? (
                    <div className="bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
                        <div className="mb-6 text-center">
                            ...
                            <h2 className="text-2xl font-bold text-gray-900 mb-2">Select NDC Source</h2>
