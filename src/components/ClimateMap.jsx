...
export default function ClimateMap({ projects }) {
  ...
  const center = validProjects.length > 0
    ? [
      validProjects.reduce((sum, p) => sum + parseFloat(p.Latitude), 0) / validProjects.length,
      validProjects.reduce((sum, p) => sum + parseFloat(p.Longitude), 0) / validProjects.length
    ]
    : defaultCenter;
      ...
      <div className="h-[500px] w-full bg-gray-100 rounded-lg flex flex-col items-center justify-center space-y-4">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm mt-1">
            The filtered projects don't have valid coordinate data
          </p>
        </div>
      </div>
    );
              ...
              <div className="min-w-[250px] p-1">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className={`font-medium ${project["Implementation Status"] === "Under Implementation"
                      ? "text-green-600"
                      : "text-yellow-600"
                      }`}>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-gray-900">
                      ${project["Project Amount ($ Million)"]}M
                    </span>
                  </div>
                </div>
              </div>
